 ...
 * @copyright	Author
 *
 * Modified by Cédric KEIFLIN for Template Creator
 *
 */
...
var MooRainbow = new Class({
	...
	OverlayEvents: function() {
		...
		this.cleaner.addEvent('click', function() {
			this.fireEvent('onClean', [this.sets, this]);
		}.bind(this));
		
		this.copy.addEvent('click', function() {
			this.fireEvent('onCopy', [this.sets, this]);
		}.bind(this));
		
		this.paste.addEvent('click', function() {
			this.fireEvent('onPaste', [this.sets, this]);
		}.bind(this));
	...
	doLayout: function() {
		...
		this.cleaner = document.getElement('#' + idPrefix + 'cleaner');
		this.copy = document.getElement('#' + idPrefix + 'copy');
		this.paste = document.getElement('#' + idPrefix + 'paste');
