...
class TemplatecksControllerTemplateck extends TemplatecksController {
    ...
    function save() {
        ...
        if ($task == 'save') {
            ...
            $link = 'index.php?option=com_templateck&controller=templateck&task=edit&cid[]=' . $model->getId();
        }
