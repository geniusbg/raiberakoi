...
class TemplatecksModelMobile extends JModel {
    ...
    function &getTemplate() {
		...
		if (!$this->_data->htmlcode_responsive) $this->_data->htmlcode_responsive = $this->genHtmlcoderesponsive($this->_data->htmlcode);
