...
class TemplateckControllerTemplate extends TemplateckController {
	...
	public function edit() {
		...
		$this->setRedirect(JRoute::_('index.php?option=com_templateck&view=template&layout=edit' . $template . '&id=' . $editId, false));
	}
	...
	public function save() {
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_templateck&view=template&layout=edit&id=' . $id, false));
			return false;
		}
		...
		if ($return === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_templateck&view=template&task=template.edit&layout=edit&id=' . $id, false));
			return false;
		}
		...
		$this->setRedirect(JRoute::_('index.php?option=com_templateck&view=template&task=template.edit&layout=edit&template=templatecreatorck&id=' . $return, false));
	...
	function cancel() {
		...
		$this->setRedirect(JRoute::_(JUri::root(true) . '/administrator/index.php?option=com_templateck&view=templates', false));
		// }
	}
}