...
<div id="body" class="body ckbloc editor">
	...
	echo TemplateCreatorck::maincontent($blockid = '', $left = true, $right = true, $maintop = true, $mainbottom = true, $centertop = true, $centerbottom = true);
	echo TemplateCreatorck::flexiblemodules('modulesbottom', 'position-13,position-14,position-15,position-16,position-17');
