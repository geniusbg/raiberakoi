...
class JFormFieldCkcolor extends JFormField {
    ...
    protected function getInput() {
        $path = $this->getPathToElements() .'/jscolor/';
        JHTML::_('script', 'jscolor.js', $path);
        $styles = $this->element['styles'];
        $html = '<img src="' . $this->getPathToElements() . '/images/color.png" /><input class="color {';
        ...
        $html.= '}" type="text" value="' . $this->value . '" name="' . $this->name . '" style="width:100px;border-radius:3px;-moz-border-radius:3px;'.$styles.'" />';
        return $html;
    }
