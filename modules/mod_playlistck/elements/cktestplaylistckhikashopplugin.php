...
class JFormFieldCktestplaylistckhikashopplugin extends JFormField {

	protected $type = 'cktestplaylistckhikashopplugin';
	...
	protected function getLabel() {
		...
		if ((string) $this->element['hr'] == 'true') {
			...
			$testpatch = $this->testPatch('playlistckhikashop');
	...
	protected function testPatch($component) {
		if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component . '/' . $component . '.php') && JPluginHelper::isEnabled('system', $component)) {
			...
			return JText::_('PLG_PLAYLISTCKHIKASHOP_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
		}
		return false;
	}
