...
class JFormFieldCktestplaylistckparamsplugin extends JFormField {
	...
	protected function getLabel() {
		...
		if ((string) $this->element['hr'] == 'true') {
			...
			$testpatch = $this->testPatch('playlistckparams');
	...
	protected function testPatch($component) {
		if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component . '/' . $component . '.php') && JPluginHelper::isEnabled('system', $component)) {
			...
			return JText::_('MOD_PLAYLISTCK_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
		}
		return false;
	}
