...
class JFormFieldCktestplaylistckvirtuemartplugin extends JFormField {

	protected $type = 'cktestplaylistckparamsplugin';
	...
	protected function getLabel() {
		...
		if ((string) $this->element['hr'] == 'true') {
			...
			$testpatch = $this->testPatch('playlistckvirtuemart');
	...
	protected function testPatch($component) {
		if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component . '/' . $component . '.php') && JPluginHelper::isEnabled('system', $component)) {
			...
			return JText::_('PLG_PLAYLISTCKVIRTUEMART_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
		}
		return false;
	}
